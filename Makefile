...
api-mutants:
	cd $(API) && INFRX_MUTANTS=all uv run --frozen pytest -q tests/contracts/test_mutants.py tests/m/test_mutants.py tests/q/test_mutants.py tests/q/test_valkey_mutants.py tests/j/test_mutants.py tests/w/test_mutants.py tests/w/test_loop_mutants.py tests/t/test_trace_mutants.py tests/d/test_migration_mutants.py tests/g/test_mutants.py tests/i/test_mutants.py tests/contracts/v2/test_mutants_v2.py
