...
# RESTARTED onto its pinned image and media root, runtime restarted, /readyz, reaper
# timer, and only then the edge's normal site. Exit 2 = refused, nothing changed (the
