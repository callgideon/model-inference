...
# Contracts v2 (F2P wire-in, item 2): a sibling of `SUITES`, not an entry in it, because
# its factory returns a `V2Harness` of trusted directories rather than a port `Harness`,
