...
MUTANTS: tuple[Mutant, ...] = (
    ...
    _m("attach_accepts_a_forged_upload_ref",
       "an upload ref binds only to the tenant's source object carrying its digest",
       U, '        if ref.storage_ref != self._key(org_id, ref.digest, ref.profile_version, "source") \\\n'
    ...
    _m("attach_ignores_the_source_key",
       "an upload ref naming another tenant's object with the same bytes binds nothing",
       U, '        if ref.storage_ref != self._key(org_id, ref.digest, ref.profile_version, "source") \\\n'
          "                or ",
       "        if ",
       "test_upload_restart__forged_digest_or_a_second_finalize_never_replaces_accepted_bytes"),
    _m("upload_ref_bound_by_the_index", "an admitted job's upload ref binds by its object",
