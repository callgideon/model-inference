#!/usr/bin/env python3
"""R32/R40: run D5's adapter mutation list (no Docker). A surviving mutant fails the suite.
...
from . import code_mutants_d5 as mutation_list
...
def test_the_list_is_well_formed() -> None:
    ...
    print(f"D5 code mutants: {len(ALL)}")
