...
MUTANTS: tuple[Mutant, ...] = (
    ...
    _m("every_relay_shares_one_worker_id",
       "D2 OB-1b: each relay claims and acknowledges under its own worker id",
       'default_factory=lambda: f"q3-relay-{uuid.uuid4().hex[:8]}")',
       'default_factory=lambda: "q3-relay")',
       "test_q3_relay__two_default_relays_claim_under_different_worker_ids"),
    ...
    _m("a_full_index_fails_the_pass",
       "review DUR-7: a full index defers the rest of a repair to the next pass",
       '                report["deferred"] += 1           # the next pass retries it',
       "                raise",
       "test_q3_reconcile__a_full_index_defers_the_rest_of_the_repair"),
