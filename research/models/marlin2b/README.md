...
| [**a100**](a100.md) | vLLM ≥ 0.17.0 / SGLang ≥ 0.5.9 + remap | 1 | 1 × TP1, 8 DP/node | BF16 (no FP8/FP4 silicon) | **FA2**; **no FlashQLA (SM80)** → GDN *prefill* on Triton/FLA; GDN *decode* fused CUDA ✅ | 517 | 38 | 201 | 20,011 · 12.79 ms (b=256) | 23,450 (b=887) | $0.0221–0.0476 | $0.0188–0.0406 | $0.0112–0.0242 | estimate |
...
2. **A100 usable HBM: 72.0 GiB or 67.06 GiB — RESOLVED 2026-09-19: `architecture.md`'s decimal reading is authoritative.** [architecture.md §8.5](architecture.md) reads METHODOLOGY §8's pinned "80 GB" as decimal and lands on **67.06 GiB usable (72.0 GB)**; [a100.md §1.1](a100.md) used to read `nvidia-smi`'s 81,920 MiB as 80 **GiB** → 72.0 GiB. **The decimal reading wins and is now the tree-wide planning basis** — METHODOLOGY §8 pins 80 GB and `gpus/a100.md` §2 itself flags the 81,920 MiB figure as ⚠️ TO BE VERIFIED with no primary NVIDIA source ([METHODOLOGY resolution log](../../METHODOLOGY.md), [gpus/a100.md §2](../../gpus/a100.md)). `a100.md` §1.1/§1.3/§6 were rewritten onto it and keep the 72.0 GiB reading only as a labelled +7.4 % sensitivity, so the **a100** row above moved **562 → 517** seats @8K, 41 → 38 @128K and 218 → 201 @video (no throughput or $/1M cell changed — no feasibility verdict flipped). The remaining ±5 % spread (517 → 570) is now purely disagreement 3, the weights question.
