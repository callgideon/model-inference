...
| **A100 capacity basis.** Was: METHODOLOGY §8's 80 GB decimal vs `gpus/a100.md` §2's 80 GiB (85.90 GB). | **RESOLVED 2026-09-19 → 80 GB decimal** (`usable_hbm` 72.0 GB = 67.06 GiB/GPU) is the tree-wide planning basis; the `nvidia-smi` 80 GiB reading is a labelled ⚠️ +7.4 % sensitivity ([METHODOLOGY §8](../../METHODOLOGY.md#gpus), [gpus/a100.md §2](../../gpus/a100.md)). [a100.md](./a100.md) already used it — no number here moved. |
...
- [`a100.md`](./a100.md) — §1.0 the capacity basis (resolved 2026-09-19 to 80 GB decimal), §1.3 concurrency, §2 kernel matrix, §3.2 grid and the compute ceiling, §3.4 the sm_86 calibration, §4 cost, §6 risks
...
- **2026-09-19 — gap `C1-a100-capacity-basis` CLOSED at 80 GB decimal.** The A100 row in *Where the documents disagree* is now a resolution, not an open conflict: `usable_hbm` = 0.90 × 80 GB = 72.0 GB = 67.06 GiB/GPU tree-wide, the `nvidia-smi` 81,920 MiB = 80 GiB = 85.90 GB reading kept only as a labelled ⚠️ TO BE VERIFIED +7.4 % sensitivity ([METHODOLOGY §8](../../METHODOLOGY.md#gpus), [gpus/a100.md §2](../../gpus/a100.md)). No concurrency, throughput or cost figure in this README changed — [`a100.md`](./a100.md) already planned on the decimal basis.
