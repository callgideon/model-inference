...
| U2 | implemented / U | [Keys and privacy/settings controls](consumer-v1/04-app.md) | U1R, F2P, F2C | C3A |
| U3 | implemented / U | [Operator grants, suspension and pilot operations](consumer-v1/04-app.md) | U1R, F2P, F2C | C3A |
...
| C3A | implemented / C | [Consumer key/privacy and platform operator actions](consumer-v1/04-app.md) | F2P, C0, F2C | D5, D10, G8 |
...
| U4 | implemented / U | [Expose owned consumer request detail and result lifecycle](consumer-v1/04-app.md) | F2C, U1R | C0, C3A, G7 |
