...
- 2026-09-25 (run3 fetched): the third certification run on bda1586 (`models/marlin2b/results/E4B-box-bda1586/run3-20260924T202924Z/`, 15,076 s, exit 1) closes nothing in §1: soak PENDING (gpu_growth and reconciled_at_end unknown — no GPU sample, no runtime reconciliation producer), dataset-resume FAIL (regime mismatch, not a runtime defect), envelope FAIL (0.5/s supported), overload PASS (32 → 8 accepted / 24 refused, honest refusals), recovery-box PENDING (coordinator drills). BACKEND-READY remains not claimed; the corrective wave (program 22) supersedes this candidate for E4C.
