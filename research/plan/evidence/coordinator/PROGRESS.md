...
Generated 2026-09-26 04:22Z UTC by `python3 research/plan/scripts/progress.py` from [tasks.json](../../tasks.json) (manifest v4) and [progress-state.json](progress-state.json) (overlay revision 80, updated 2026-09-26 04:22Z UTC). Generated file; never hand-edit. Program: [consumer-v1 (program 22)](../../22-consumer-v1-implementation.md). Full view: [progress.html](progress.html).
...
| E3C | E3C final BACKEND-LOCAL on integration tip 04ae5e21 (merged as 601f4c1d) with E3A-WR-1, E3A-WR-2, WR-W5F5B-3 (R139) and both revert-type controls | complete | codex/e3c-rerun | 04ae5e21 → 5c4f6d7b | ports compose block 56900-56999 (postgres 56932), prefix infrx-e3c-, db infrx_e3c | 2026-09-26 04:07Z | merged at dcce7775; E3C implemented; BACKEND-LOCAL accepted; a rerun on the 0024/0025 tip follows the D10-MERGE-2 merge (harness only) | 0–0.5 h remaining (likely 0 h), confidence high, estimated 2026-09-26 04:06Z; basis: gate passed on the integration tip; left is the coordinator merge of codex/e3c-rerun |
...
| G8-FLAG | support G8 micro-lane (GAP-I3-1, I3R-7, R144): an audited `flag` CLI verb that sets one non-regime feature flag (signup_grant off alone) only through 0022 infrx.set_feature_flag; the cutover rollback runbook points at it; self-verifying workflow wf_3b2a85e9-f9d | complete | codex/g8-flag | 34f0ed28 → 5e45b79e | ports g8 postgres 55447, prefix infrx-g8- | 2026-09-26 04:22Z | merged --no-ff at a30631a8; WR-G8FLAG-1/2/3 applied at e7b1c272 (operations.md step 2 → the flag verb + ops03 asserts; R144 amended: flag verb + the maintenance-drill exception); GAP-I3-1 / I3R-7 closed; minors carried: 0-G8FLAG-R2 audit operation unpinned in the test, R3 lock-bound mutants need PG, R4 write-then-audit crash window (shared with credit-transition), R6 --dry-run still needs --on/--off; fixed-clone checks running | 1–4 h remaining (likely 2 h), confidence medium, estimated 2026-09-26 04:20Z; basis: one verb + tests + two doc pointers; 2 lenses, one fix round |
