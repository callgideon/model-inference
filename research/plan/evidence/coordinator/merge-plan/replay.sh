...
for step in 1-d5-terminal-transaction 2-e3b-phase3-bodies 3-cutover-mount 4-m1l2-object-store \
            5-m-pilot-media 6-e4b-certify 7-box-measure 8-rollout-prep 8b-i2b-r4-worker 9-rulings 9b-rulings-more 3b-cutover-fix 10-prep-worker 10b-rulings-prep; do
